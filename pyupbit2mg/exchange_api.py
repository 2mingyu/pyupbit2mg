...
from pyupbit2mg.request_api import _send_get_request, _send_post_request, _send_delete_request
...
class Upbit:
    ...
    # 출금 가능 정보  - 2mg
    def get_withdraw_chance(self, currency, net_type, contain_req=False):
        try:
    ...
    #     코인 출금하기  - 2mg net_type, secondary_address
    def withdraw_coin(self, currency, amount, address, net_type, secondary_address='None', transaction_type='default', contain_req=False):
        """
        코인 출금
    ...
    # 출금 허용 주소 리스트 조회 - 2mg
    def get_withdraw_address(self, contain_req=False):
        try:
